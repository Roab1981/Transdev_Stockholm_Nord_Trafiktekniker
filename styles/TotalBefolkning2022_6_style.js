...
var style_TotalBefolkning2022_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Totalbefolkning");
    var labelText = "";
    size = 0;
    ...
    if (value >= 1.000000 && value <= 25.000000) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.65)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(255,255,255,0.65)'}),
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 800.000000 && value <= 24658.000000) {
            style = [ new ol.style.Style({
